(function() {
    ...
    ConsoleReporter.prototype = {
        reportRunnerResults: function(runner) {
            if (this.hasGroupedConsole()) {
                ...
                this.failedCount = runner.results().failedCount;
                console.log('suite successes: ' + runner.results().passedCount);
                console.log('suite failures: ' + runner.results().failedCount);
        ...
        reportSpecResults: function(spec) {
            if (!this.hasGroupedConsole()) {
                ...
                if (spec.results().passed()) {
                    this.passed_specs++;
                    resultText = spec.description + " passed.";
                }
    ...
    function specResults(spec) {
        ...
        console.info('Spec: ' + spec.description);
