...
- Unreleased
    - Fixed bug in CapiModel where change events were not being fired for keys added after model instantiation
        - (BREAKING CHANGE) because listeners registered with 'on' in CapiModel
